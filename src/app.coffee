    ...
    body ->
      ...
      div '.container', ->
        ...
        div style: 'float:right', ->
          a '.twitter-share-button', href: 'https://twitter.com/share', 'data-url': 'http://html2coffeecup.nodejitsu.com', 'data-text': 'Convert your html to coffeecup! #coffeescript #nodejs', 'Tweet'
